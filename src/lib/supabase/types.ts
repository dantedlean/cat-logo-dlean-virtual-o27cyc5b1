...
// Table: products
//   Policy "admin_all_products" (ALL, PERMISSIVE) roles={authenticated}
...
//     USING: true
// Table: site_content
//   Policy "admin_all_site_content" (ALL, PERMISSIVE) roles={authenticated}
//     USING: ((auth.jwt() ->> 'email'::text) = 'dante@dlean.com.br'::text)
//     WITH CHECK: ((auth.jwt() ->> 'email'::text) = 'dante@dlean.com.br'::text)
//   Policy "public_read_site_content" (SELECT, PERMISSIVE) roles={public}
//     USING: true
